...
cartRouter.post('/:cid/products/:pid', passportError('jwt'), authorization('userPremium'), postCartProduct);
...
cartRouter.post('/:cid/purchase', passportError('jwt'), authorization('userPremium'), postCartPurchase);
